...
public enum DinErrorEnum {
    ...
    CUSTOMER_CREATED("1000", "1000", "Customer created successfully", "SUCCESS"),
    CUSTOMER_NOT_FOUND("404", "1002", "Customer not found", "WARNING"),
    CUSTOMER_DELETED("1000", "1003", "Customer deleted successfully", "SUCCESS"),
    CREATION_ERROR("1", "1010", "Creation failed", "ERROR"),

    ACCOUNT_CREATED("0", "2000", "Account created successfully", "SUCCESS"),
    ACCOUNT_NOT_FOUND("404", "2001", "Account does not exist", "WARNING"),
